...
def handle_access_log(filepath):
    ...
    try:
        ...
        if error_403>0:
            ...
            print("")  
            print(error_403," Logs with 403 Error were found")
        ...
        if error_401>0:
            ...
            print("")
            print(error_401," Logs with 401 Error were found")

        print("")            
        print("Total ",log_count," Logs were scanned") 
        print("") 
...
def handle_app_log(filepath):
    ...
    try:
        ...
        if error_no>0:
            print("") 
            print(error_no," Logs with Error were found")
            
        if critical_no>0:
            print("") 
            print(critical_no," Logs with Error were found")

        if warn_no>0:
            print("")
            print(warn_no," Logs with Warning were found")
        
        issue=error_no+critical_no+warn_no
